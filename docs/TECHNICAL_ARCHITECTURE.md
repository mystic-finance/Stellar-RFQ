...
[TECHNICAL_ARCHITECTURE_EN.md](https://github.com/user-attachments/files/28936275/TECHNICAL_ARCHITECTURE_EN.md)
...
2. The Facility records the RWA via `book\\\_redemption()`
...
2. **Anti-manipulation guardrail**: the taker knows the reference value and sets `min\\\_out` accordingly
